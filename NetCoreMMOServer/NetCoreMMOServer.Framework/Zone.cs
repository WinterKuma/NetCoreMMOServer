...
namespace NetCoreMMOServer.Framework
{
    ...
    public class Zone
    {
        ...
        private readonly List<NetEntity> _oldEntities = new();
        private readonly List<NetEntity> _currentEntities = new();
        private readonly List<NetEntity> _addEntities = new();
        private readonly List<NetEntity> _removeEntities = new();

        private readonly ZoneSimulator _physicsSimulator;
        private readonly List<NetEntity> _aroundEntities = new();
        ...
        public List<NetEntity> OldEntities => _oldEntities;
        public List<NetEntity> CurrentEntities => _currentEntities;
        public List<NetEntity> AddEntities => _addEntities;
        public List<NetEntity> RemoveEntities => _removeEntities;
